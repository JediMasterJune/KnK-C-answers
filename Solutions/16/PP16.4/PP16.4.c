...
void price(struct part* pInven, int* pNum_parts);
...
void insert(struct part* pInven, int* pNum_parts)
{
    ...
    printf("Enter price: ");
    scanf("%d", &((pInven + *pNum_parts)->price));
    (*pNum_parts)++;
}
...
void print(struct part* pInven, int* pNum_parts)
{
    ...
    for (i = 0; i < *pNum_parts; i++)
        printf("%-11d       %-25s%-16d               %-5d\n", (pInven + i)->number,
               (pInven + i)->name, (pInven + i)->on_hand, (pInven + i)->price);
}
